...
function initialize() {
	...
	gTextArray[0][2] = "te gebruiken. Het idee "
	gTextArray[0][3] = "dat de auto niet zou starten "
	gTextArray[0][4] = "verhoogt mijn hartslag. In de verte hoor ik "
	gTextArray[0][5] = "vrachtwagens voorbij razen. Als ik mij focus "
	gTextArray[0][6] = "op het geluid, "
	gTextArray[0][7] = "kan ik het niet meer onthoren "
	gTextArray[0][8] = "en hoor ik ook "
	...
	gTextArray[0][25] = "gebrekkig, ik vind het "
	...
	gTextArray[1][1] = "het broken heart syndrome. Het hart "
	...
	gTextArray[2][0] = "Eens alles ingepakt was, zat er niets anders op dan "
	gTextArray[2][1] = "vertrekken, de deur achter mij "
	gTextArray[2][2] = "dicht trekken. Het slot omdraaien. De sleutel "
	gTextArray[2][3] = "veilig in mijn zak opbergen, binnen handbereik, "
	gTextArray[2][4] = "ik kan me omkeren "
	gTextArray[2][5] = "als ik dat wil. Hoe zal "
	gTextArray[2][6] = "mijn stem klinken als "
	gTextArray[2][7] = "ik mijn mond opendoe? Hoe eenzaam "
	gTextArray[2][8] = "zal ik mij voelen, "
	gTextArray[2][9] = "zal dat gevoel "
	gTextArray[2][10] = "zich uitspreiden over mijn borstkas en "
	gTextArray[2][11] = "als wildgroei gaan woekeren? Als "
	...
	gTextArray[2][17] = "een over een permanente zonsopgang "
	gTextArray[2][18] = "misschien. Ik kan gelukkig "
	gTextArray[2][19] = "worden vandaag, "
	gTextArray[2][20] = "een nieuw perspectief "
	gTextArray[2][21] = "van de straat rapen. Ik geloof niet in "
	...
	gTextArray[2][26] = "voor het laatst gedanst "
	...
	gTextArray[4][0] = "Naakt sta ik "
	gTextArray[4][1] = "voor de spiegel. Zie waar "
	gTextArray[4][2] = "mijn buik bolt bij iedere ademhaling. Hoe mijn schouders "
	gTextArray[4][3] = "een beetje naar voren hellen. De grote moedervlek "
	gTextArray[4][4] = "die als kind lager "
	gTextArray[4][5] = "op mijn heup zat. De ogen "
	...
	gTextArray[4][13] = "in de tekening "
	gTextArray[4][14] = "zit mijn kijken vervat. De hand die als antwoord op "
